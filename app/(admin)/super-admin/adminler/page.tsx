    ...
    return (
        <div style={{ padding: '2.5rem 3.5rem', width: '100%', maxWidth: '100%' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '3.5rem' }}>
                <div>
                    <h2 style={{ fontSize: '2rem', fontWeight: '900', color: '#111827', letterSpacing: '-0.04em', margin: 0 }}>Sistem Yetkili Yönetimi</h2>
                    <p style={{ color: '#64748b', marginTop: '8px', fontSize: '1rem', fontWeight: '500' }}>Platform kontrol panelini yöneten, yüksek yetkili yönetici ve denetçi hesapları.</p>
                </div>
                <button
                    onClick={handleOpenAdd}
                    className="hover:scale-105 active:scale-95 transition-all"
                    style={{ background: '#ff7a21', color: '#fff', padding: '14px 28px', borderRadius: '16px', border: 'none', fontSize: '0.95rem', fontWeight: '900', display: 'flex', alignItems: 'center', gap: '10px', boxShadow: '0 10px 15px -3px rgba(255, 122, 33, 0.3)', cursor: 'pointer' }}
                >
                    <UserPlus size={20} strokeWidth={2.5} /> Yeni Yönetici Yetkilendir
                </button>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 400px', gap: '3rem' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
                    ...
                    <div className="card" style={{ border: 'none', padding: 0, overflow: 'hidden', background: '#fff', borderRadius: '32px', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.05)' }}>
                        <div style={{ padding: '28px 40px', borderBottom: '1px solid #f1f5f9', background: '#fff', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <h3 style={{ fontSize: '1.2rem', fontWeight: '900', margin: 0, color: '#111827', letterSpacing: '-0.02em' }}>Yetkili Personel Listesi</h3>
                            <div style={{ fontSize: '0.85rem', color: '#64748b', fontWeight: '900', background: '#f8fafc', padding: '6px 14px', borderRadius: '10px', border: '1px solid #f1f5f9' }}>TOPLAM {admins.length} KAYIT</div>
                        </div>
                        ...
                        <div style={{ overflowX: 'auto' }}>
                            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                <thead style={{ background: '#f9fafb' }}>
                                    <tr>
                                        <th style={{ padding: '20px 40px', textAlign: 'left', fontSize: '0.75rem', fontWeight: '900', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Kimlik & İletişim</th>
                                        <th style={{ padding: '20px 40px', textAlign: 'left', fontSize: '0.75rem', fontWeight: '900', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Rol / Erişim</th>
                                        <th style={{ padding: '20px 40px', textAlign: 'left', fontSize: '0.75rem', fontWeight: '900', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Yetki Durumu</th>
                                        <th style={{ padding: '20px 40px', textAlign: 'left', fontSize: '0.75rem', fontWeight: '900', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Kayıt Tarihi</th>
                                        <th style={{ padding: '20px 40px', textAlign: 'right', fontSize: '0.75rem', fontWeight: '900', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Yönetim</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {loading ? (
                                        <tr>
                                            <td colSpan={5} style={{ padding: '120px', textAlign: 'center' }}>
                                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px', color: '#64748b' }}>
                                                    ...
                                                    <span style={{ fontWeight: '900', fontSize: '1.1rem', letterSpacing: '-0.02em' }}>ADMIN VERİTABANI TARANIYOR...</span>
                                                </div>
                                            </td>
                                        </tr>
                                    ) : error ? (
                                        ...
                                        <tr>
                                            <td colSpan={5} style={{ padding: '120px', textAlign: 'center' }}>
                                                <div style={{ fontSize: '1.25rem', color: '#94a3b8', fontWeight: '900', letterSpacing: '-0.02em' }}>Henüz yetkilendirilmiş bir hesap bulunamadı.</div>
                                            </td>
                                        </tr>
                                    ) : admins.map((admin) => (
                                        <tr key={admin.id} style={{ borderBottom: '1px solid #f8fafc', transition: 'all 0.3s' }} className="group hover:bg-slate-50/50">
                                            <td style={{ padding: '28px 40px' }}>
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                                                    <div style={{ width: '52px', height: '52px', borderRadius: '18px', background: 'linear-gradient(135deg, #0f172a 0%, #334155 100%)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.25rem', fontWeight: '900', border: '2px solid #e2e8f0', boxShadow: '0 8px 16px -4px rgba(0,0,0,0.15)', textShadow: '0 2px 4px rgba(0,0,0,0.3)' }}>
                                                        {admin.name?.charAt(0) || admin.email.charAt(0).toUpperCase()}
                                                    </div>
                                                    <div>
                                                        <p style={{ margin: 0, fontWeight: '900', fontSize: '1.1rem', color: '#111827', letterSpacing: '-0.02em' }}>{admin.name || 'İsimsiz Yönetici'}</p>
                                                        <p style={{ margin: '6px 0 0', fontSize: '0.85rem', color: '#94a3b8', fontWeight: '700', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                                            <Mail size={14} strokeWidth={2.5} /> {admin.email}
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td style={{ padding: '28px 40px' }}>
                                                ...
                                                >
                                                    <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: admin.emailVerified ? '#10b981' : '#f59e0b', boxShadow: admin.emailVerified ? '0 0 12px rgba(16, 185, 129, 0.4)' : 'none' }} className={admin.emailVerified ? "animate-pulse" : ""} />
                                                    <span style={{ fontSize: '0.85rem', fontWeight: '900', letterSpacing: '0.02em' }}>{admin.emailVerified ? 'TAM YETKİLİ' : 'DOĞRULAMA BEKLİYOR'}</span>
                                                </div>
                                            </td>
                                            <td style={{ padding: '28px 40px', fontSize: '0.95rem', color: '#64748b', fontWeight: '800', letterSpacing: '-0.01em' }}>
                                            ...
                                            <td style={{ padding: '28px 40px' }}>
                                                <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px' }}>
                                                    <button
                                                        ...
                                                        style={{ width: '44px', height: '44px', borderRadius: '14px', background: '#fff', border: '1px solid #e2e8f0', color: '#64748b', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.02)' }}
                                                    ...
                                                    <button
                                                        ...
                                                        style={{ height: '44px', padding: '0 20px', borderRadius: '14px', background: '#fef2f2', border: '1px solid #fee2e2', color: '#f43f5e', fontWeight: '900', fontSize: '0.85rem', cursor: 'pointer', transition: 'all 0.2s' }}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', position: 'sticky', top: '2.5rem', height: 'fit-content' }}>
                    <div className="card" style={{ border: 'none', padding: '40px', background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)', color: '#fff', borderRadius: '32px', boxShadow: '0 30px 40px -15px rgba(0, 0, 0, 0.4)', position: 'relative', overflow: 'hidden' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '32px', position: 'relative', zIndex: 1 }}>
                            <div style={{ background: 'rgba(255,255,255,0.05)', padding: '12px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.1)' }}>
                                <Shield size={28} color="#ff7a21" strokeWidth={2.5} />
                            </div>
                            <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: '900', textTransform: 'uppercase', letterSpacing: '0.15em' }}>Güvenlik Protokolü</h3>
                        </div>
                        <p style={{ margin: 0, fontSize: '1rem', color: '#94a3b8', lineHeight: '1.8', fontWeight: '500', position: 'relative', zIndex: 1 }}>
                        ...
                        <button className="hover:scale-105 active:scale-95 transition-all" style={{ width: '100%', marginTop: '40px', padding: '18px', borderRadius: '18px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', color: '#fff', fontSize: '1rem', fontWeight: '900', cursor: 'pointer', position: 'relative', zIndex: 1, backdropFilter: 'blur(10px)' }}>
                            Güvenlik Loglarını İncele
                        </button>
                    </div>

                    <div className="card" style={{ border: 'none', padding: '36px', background: '#fff', borderRadius: '32px', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.05)' }}>
                        <div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start' }}>
                            <div style={{ background: '#f5f3ff', padding: '14px', borderRadius: '16px', border: '1px solid #ede9fe' }}>
                                <Lock size={28} color="#6366f1" strokeWidth={2.5} />
                            </div>
                            <div>
                                <h4 style={{ margin: '0 0 10px 0', fontSize: '1.1rem', fontWeight: '900', color: '#111827', letterSpacing: '-0.02em' }}>Erişim Koruması</h4>
                                <p style={{ margin: 0, fontSize: '0.95rem', color: '#64748b', lineHeight: '1.7', fontWeight: '500' }}>
            ...
            {isModalOpen && (
                <div style={{
                    ...
                    <div className="card" style={{ width: '100%', maxWidth: '560px', padding: '54px 64px', border: 'none', borderRadius: '40px', boxShadow: '0 40px 80px -20px rgba(0,0,0,0.4)', background: '#fff', position: 'relative', animation: 'modalFadeIn 0.3s ease-out' }}>
                        <button
                            onClick={() => setIsModalOpen(false)}
                            style={{ position: 'absolute', top: '32px', right: '32px', background: '#f1f5f9', border: 'none', padding: '10px', borderRadius: '14px', cursor: 'pointer', color: '#64748b' }}
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '48px' }}>
                            <div style={{ background: '#fff7ed', padding: '16px', borderRadius: '20px', border: '1px solid #ffedd5' }}>
                                <UserPlus size={32} color="#ff7a21" strokeWidth={2.5} />
                            </div>
                            <div>
                                <h3 style={{ margin: 0, fontSize: '1.75rem', fontWeight: '900', color: '#111827', letterSpacing: '-0.04em' }}>
                                    {editingAdmin ? 'Yetkilendirme Güncelle' : 'Personel Yetkilendir'}
                                </h3>
                                <p style={{ margin: '6px 0 0', fontSize: '1rem', color: '#64748b', fontWeight: '500' }}>Yönetici kimlik ve erişim bilgilerini yapılandırın.</p>
                            </div>
                        </div>
