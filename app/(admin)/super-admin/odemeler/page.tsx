        ...
        <div className="p-4 md:p-8 lg:p-12 w-full max-w-full">
            ...
            <div className="mb-8 md:mb-12 flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                    ...
                    <button
                        ...
                        className="flex-1 sm:flex-none bg-[#ea580c] text-white px-8 py-3.5 rounded-2xl font-black text-sm flex items-center justify-center gap-2.5 shadow-xl shadow-orange-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                <div className="bg-slate-900 rounded-[40px] p-10 text-white shadow-2xl shadow-slate-900/10 relative overflow-hidden group hover:-translate-y-1 transition-all duration-500">
                    <div className="absolute -right-5 -top-5 w-40 h-40 bg-orange-600/10 rounded-full blur-3xl group-hover:scale-150 transition-transform duration-1000"></div>
                    <div className="relative">
                        <div className="flex justify-between items-start mb-10">
                            ...
                            <div className="bg-white/5 p-4 rounded-2xl border border-white/10 text-[#ea580c] shadow-xl">
                ...
                <div className="bg-white rounded-[40px] p-10 shadow-sm border border-slate-100 group hover:shadow-xl hover:shadow-slate-200/40 hover:-translate-y-1 transition-all duration-500">
                    <div className="flex justify-between items-start mb-10">
                        <div>
                            ...
                            <h3 className="text-4xl font-black text-gray-900 tracking-tighter leading-none group-hover:text-[#ea580c] transition-colors transition-all">₺{monthlyRevenue.toLocaleString('tr-TR')}</h3>
                        </div>
                        <div className="bg-blue-50 p-4 rounded-2xl border border-blue-100 text-blue-500 group-hover:bg-[#ea580c] group-hover:text-white group-hover:border-transparent transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] font-black text-[#ea580c] uppercase tracking-tighter">Artış +12.4%</span>
                    </div>
                </div>
                        ...
                        <div className="p-10 border-b border-slate-50 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-8 bg-white shrink-0">
                            ...
                            <div className="relative w-full sm:w-auto overflow-hidden">
                                ...
                                <input
                                    ...
                                    className="w-full sm:w-80 pl-14 pr-6 py-4 rounded-[20px] border border-slate-200 bg-slate-50/50 text-sm font-bold text-gray-900 outline-none focus:bg-white focus:border-[#ea580c] focus:ring-4 focus:ring-orange-50 transition-all placeholder:text-slate-400/70 shadow-inner"
                                />
                            </div>
                        </div>
                                            ...
                                            <td colSpan={5} className="p-40 text-center">
                                                <div className="flex flex-col items-center gap-8">
                                                    ...
                                                    <div className="flex flex-col gap-2">
                                                        ...
                                                        <button onClick={() => setModalOpen(true)} className="text-[10px] font-black text-[#ea580c] underline underline-offset-4 hover:text-orange-600 transition-colors uppercase tracking-widest mt-2">İLK Manuel Girişi Yapın</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <tr key={p.id} className="hover:bg-slate-50 transition-all duration-300 group">
                                                <td className="px-10 py-8">
                                                    <div className="flex items-center gap-5">
                                                        <div className="w-12 h-12 rounded-2xl bg-white border border-slate-100 flex items-center justify-center text-[#ea580c] shadow-sm group-hover:bg-[#ea580c] group-hover:text-white transition-all duration-300">
                                                            <DollarSign size={20} strokeWidth={3} />
                                                        </div>
                                                        <div>
                                                            <div className="text-sm font-black text-gray-900 group-hover:text-[#ea580c] transition-colors tracking-tight">#{p.id.substring(0, 8).toUpperCase()}</div>
                                                ...
                                                <td className="px-10 py-8">
                                                    <div className="text-sm font-black text-gray-900 hover:text-[#ea580c] transition-colors cursor-pointer">{p.tenant?.name || 'BELİRSİZ'}</div>
                    ...
                    <div className="bg-slate-900 rounded-[40px] p-10 text-white shadow-2xl shadow-slate-900/10 relative overflow-hidden group">
                        ...
                        <div className="relative">
                            <div className="flex items-center gap-4 mb-10">
                                <div className="bg-orange-600/10 p-3 rounded-2xl text-[#ea580c]">
                            ...
                            <div className="space-y-8">
                                <div>
                                    ...
                                    <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                                        <div className="h-full bg-gradient-to-r from-[#ea580c] to-orange-400 w-[74%] rounded-full shadow-lg shadow-orange-500/20"></div>
                                    </div>
                                </div>
                                <div>
                                    <div className="flex justify-between items-end mb-3">
            ...
            {modalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8 overflow-y-auto">
                    ...
                    <div className="relative w-full max-w-2xl bg-white rounded-[40px] p-8 md:p-12 shadow-2xl animate-in zoom-in duration-300">
                        ...
                        <div className="mb-10">
                            <div className="w-16 h-16 bg-orange-50 text-[#ea580c] rounded-3xl flex items-center justify-center mb-6">
                                <PlusCircle size={32} />
                            </div>
                        ...
                        <form onSubmit={handleSave} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <button
                                ...
                                className="md:col-span-2 mt-4 bg-[#ea580c] text-white py-5 rounded-[24px] font-black text-lg flex items-center justify-center gap-3 shadow-xl shadow-orange-500/30 hover:scale-[1.02] active:scale-95 disabled:opacity-70 transition-all"
                            >
